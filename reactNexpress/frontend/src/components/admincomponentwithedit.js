...
class Users extends Component {
  ...
  logChange(e) {
    this.setState({
      [e.target.name]: e.target.value   //setting value edited by the admin instate.
    });
  }
            ...
            <tbody>
              {this.state.users.map(member => 
                <tr key={member.id}>
                  ...
                  <td>
                    <a onClick={() => this.openModal(member)}>Edit</a> | <a onClick={() => this.deleteMember(member)}>Delete</a>
                  </td>
                </tr>
              )}
              ...
              <Validation.components.Form onSubmit={this.handleEdit} method="POST">
                ...
                <Validation.components.Input 
                  ...
                  value={this.state.name} placeholder="John" 
                  name="name" validations={["required"]} 
                />
                <label>Email</label>
                <Validation.components.Input 
                  onChange={this.logChange} className="form-control" 
                  value={this.state.email} placeholder="email@emil.com" 
